          ...
          <Card>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex items-center gap-3 rounded-lg border p-3 sm:col-span-2">
                <Checkbox checked={form.upstairs} onCheckedChange={(checked) => setForm((current) => ({ ...current, upstairs: !!checked }))} />
                <div>
                  <div className="text-sm font-medium">Delivery goes upstairs</div>
                  <div className="text-xs text-muted-foreground">Tell the operator now so crew planning is accurate.</div>
                </div>
              </div>
              <div className="space-y-2 sm:col-span-2">
