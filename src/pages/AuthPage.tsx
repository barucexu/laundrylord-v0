      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">
            {mode === "forgot" ? "Reset Password" : mode === "login" ? "Sign in to LaundryLord" : "Create account"}
          </CardTitle>
          <CardDescription>
            {mode === "forgot"
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">{isLogin ? "Sign in to LaundryLord" : "Create account"}</CardTitle>
          <CardDescription>
            {isLogin ? "Enter your credentials to continue" : "Set up your operator account"}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Button
